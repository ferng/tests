...
class SlotControllerAddAppointmentInvalidSlotSize59FreeSlotSpec extends Specification {
    def test() {
        given:
        ...
        slotSizes.add(15);
        slotSizes.add(60);
        def newAppt = new Appointment(1, start, LocalTime.of(12, 30), LocalTime
                .of(13, 29))
        ...
        slot.getStatus() == SlotStatus.INVALID_SLOT_SIZE
        slot.getStart() == LocalTime.of(12,30)
        slot.getEnd() == LocalTime.of(13,29)
    }
