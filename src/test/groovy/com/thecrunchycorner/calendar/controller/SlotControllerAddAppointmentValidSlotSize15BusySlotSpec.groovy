...
class SlotControllerAddAppointmentValidSlotSize15BusySlotSpec extends Specification {
    def test() {
        given:
        ...
        slotSizes.add(15);
        slotSizes.add(60);
        def newAppt = new Appointment(1, start, LocalTime.of(9, 45), LocalTime
                .of(10, 00))
        ...
        slot.getStart() == LocalTime.of(9,45)
        slot.getEnd() == LocalTime.of(10,00)
    }
